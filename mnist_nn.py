...
def main():
    ...
    nnetwork.DisplayWeights(nnetwork.best_weights[0], _width=28, _height=28, _plot_rows=20, _plot_cols=20)
    nnetwork.DisplayWeights(nnetwork.best_weights[1], _width=20, _height=20, _plot_rows=16, _plot_cols=16)
    nnetwork.DisplayWeights(nnetwork.best_weights[2], _width=16, _height=16, _plot_rows=2, _plot_cols=5)
